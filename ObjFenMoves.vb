...
#Region "Déclaration des variables"
    ...
    Private Structure InfoFEN
        ...
        Dim WhiteCanDoLittle As Boolean     'le champ 3
        Dim WhiteCanDoBig As Boolean
        Dim BlackCanDoLittle As Boolean
        Dim BlackCanDoBig As Boolean
...
#Region "Gestion des mouvements"
    ...
    Private Sub AddMove(ByVal sqiTO As Integer, ByVal sqiFROM As Byte, _
